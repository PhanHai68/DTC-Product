...
class PaddyColorSorterMenuScreen extends StatelessWidget {
  const PaddyColorSorterMenuScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return TechnologyMenuScaffold(
      title: 'Máy tách màu Thóc',
      entries: [
        TechnologyMenuEntry(
          id: 'paddy_color_sorter_specs_btn',
          title: 'Thông số kỹ thuật',
          icon: Icons.fact_check_outlined,
          featured: true,
          onTap: () => context.push('/paddy_color_sorter'),
        ),
        TechnologyMenuEntry(
          id: 'paddy_color_sorter_aux_btn',
          title: 'Thiết bị phụ trợ',
          icon: Icons.settings_outlined,
          onTap: () => context.push('/paddy_aux_equip'),
        ),
        TechnologyMenuEntry(
          id: 'paddy_color_sorter_payback_btn',
          title: 'Phân tích hoàn vốn',
          icon: Icons.query_stats_rounded,
          subtitle: 'Chờ dữ liệu riêng cho Thóc và Gạo xô',
          statusLabel: 'Sắp có',
        ),
        TechnologyMenuEntry(
          id: 'paddy_color_sorter_drawing_btn',
          title: 'Bản vẽ lắp đặt',
          icon: Icons.architecture_rounded,
          onTap: () => _showDrawingDialog(context),
        ),
        TechnologyMenuEntry(
          id: 'paddy_color_sorter_errors_btn',
          title: 'Tra cứu lỗi',
          icon: Icons.troubleshoot_rounded,
          statusLabel: 'Sắp có',
        ),
        TechnologyMenuEntry(
          id: 'paddy_color_sorter_manual_btn',
          title: 'Tài liệu vận hành',
          icon: Icons.menu_book_rounded,
          subtitle: 'Không sử dụng tài liệu của dòng máy Gạo',
          statusLabel: 'Sắp có',
        ),
      ],
    );
